...
using Board = Monday.Client.Models.Board;
using Group = Monday.Client.Models.Group;
...
{
    private MondayClient _mondayClient = A.Fake<MondayClient>();
    private IGraphQLClient _graphQlClient = A.Fake<IGraphQLClient>();
